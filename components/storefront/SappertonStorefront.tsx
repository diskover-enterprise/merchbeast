  ...
  return (
    <div style={{ fontFamily: "'Arial Black', 'Impact', sans-serif", background: '#0a0a0a', color: '#f5f5f5', minHeight: '100vh' }}>
      <style>{`
        ...
        .ss-hero-placeholder { width: 100%; height: 420px; background: linear-gradient(135deg, #1a0000 0%, #0a0a0a 50%, #1a0a00 100%); display: flex; align-items: center; justify-content: center; }
