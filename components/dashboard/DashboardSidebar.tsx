...
import { LayoutDashboard, ShoppingBag, Package, Settings, LogOut, DollarSign, Store, Tag, Percent } from 'lucide-react'
...
const links = [
  ...
  { href: '/dashboard/sales',       label: 'Sales',       icon: Percent },
