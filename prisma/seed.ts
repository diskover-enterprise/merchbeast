...
const restaurants = [
  {
    ...
    bannerImage: U('1529193591184-b1d58069ecdd', 1400, 600),
    logo: U('1558618666-fcd25c85cd64', 200, 200),
    products: [
  ...
  },
  {
    ...
    bannerImage: U('1579871494447-9811cf80d66c', 1400, 600),
    logo: U('1553621042-f6e147245754', 200, 200),
    products: [
  ...
  },
  {
    ...
    primaryColor: "#f7c5d5",
    secondaryColor: "#fff9fc",
    accentColor: "#d4a5c9",
    fontFamily: "Dancing Script",
    ownerEmail: "owner@pastel-cakery.com",
    bannerImage: U('1486427944299-d1955d23e34d', 1400, 600),
    logo: U('1464349095431-e9a21285b5f3', 200, 200),
    products: [
  ...
  },
  {
    ...
    bannerImage: U('1513104890138-7c749659a591', 1400, 600),
    logo: U('1571997478779-2adcbbe9ab2f', 200, 200),
    products: [
  ...
  },
  {
    ...
    bannerImage: U('1568901346375-23c9450c58cd', 1400, 600),
    logo: U('1568901346375-23c9450c58cd', 200, 200),
    products: [
  ...
  },
  {
    ...
    bannerImage: U('1569050467447-ce54b3bbc37d', 1400, 900),
    logo: '/lunch-lady-logo.png',
    products: [
...
const customerNames = [
  ...
  { name: 'Jamie Chen', email: 'jamie.c@example.com' },
  { name: 'Sam Patel', email: 'sam.p@example.com' },
  { name: 'Morgan Wu', email: 'morgan.w@example.com' },
  { name: 'Taylor Brooks', email: 'taylor.b@example.com' },
]
...
async function main() {
  ...
  // Delete admin users too
  await prisma.adminUser.deleteMany()

  // Create platform admin
  await prisma.adminUser.create({
    data: {
      email: 'admin@afterdessert.com',
      passwordHash: bcrypt.hashSync('admin123', 10),
    },
  })
  console.log('✅ Platform admin: admin@afterdessert.com / admin123')
  ...
  for (const r of restaurants) {
    ...
    // Create 3-5 sample orders per restaurant
    ...
    for (let i = 0; i < numOrders; i++) {
      ...
      const orderItems = shuffled.map((p) => ({
        productId: p.id,
      ...
      await prisma.order.create({
        data: {
          ...
          restaurantId: restaurant.id,
          status: ['paid', 'fulfilled', 'paid'][Math.floor(Math.random() * 3)],
          total: Math.round(total * 100) / 100,
          stripePaymentId: `pi_test_${Math.random().toString(36).slice(2, 18)}`,
          createdAt,
    ...
    console.log(`✅ ${restaurant.name} — ${products.length} products, ${numOrders} orders`)
  }

  console.log('\n🎉 Seed complete!')
  console.log('\nOwner login credentials:')
  for (const r of restaurants) {
    console.log(`  ${r.name}: ${r.ownerEmail} / password123`)
  }
}
