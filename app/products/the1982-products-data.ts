...
export const the1982Products: The1982Product[] = [
  ...
  {
    slug: 'michael-jordan',
    name: 'Michael Jordan UNC',
    price: '$50.00 CAD',
    description: 'In 1982 a freshman stepped on the scene and changed the game forever.',
    path: '/shop/the-1982/products/michael-jordan',
    images: [
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/michaeljordanblack.jpg?v=1693775455',
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/michaeljordanwhite.jpg?v=1693775455',
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/Michaeljordanvintageblack.jpg?v=1693775455',
    ],
    sizes: ['S', 'M', 'L', 'XL', '2XL'],
    colors: ['Black', 'White', 'Vintage Black'],
    category: 'Tee',
  },
  {
    ...
    name: 'Manny Pacquiao',
    price: '$50.00 CAD',
    description: 'Honouring the G.O.A.T. Manny is low key a hooper. Oversized street style fit.',
    path: '/shop/the-1982/products/manny-pacquiao',
    images: [
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/MannyPblack.jpg?v=1684893751',
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/MannyPwhite.jpg?v=1684893727',
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/mannypvintageblack.jpg?v=1684893739',
    ],
    sizes: ['S', 'M', 'L', 'XL', '2XL'],
    colors: ['Black', 'White', 'Vintage Black'],
    category: 'Tee',
  ...
  {
    slug: 'kawhi-leonard-the-shot',
    name: 'Kawhi Leonard "The Shot" Game 7',
    price: '$50.00 CAD',
    description: 'The ball bounces, bounces, bounces, bounces and finally drops in. Game 7, Eastern Conference Finals. Oversized street style fit.',
    path: '/shop/the-1982/products/kawhi-leonard-the-shot',
    images: [
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/kawhileonardblack.jpg?v=1684894599',
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/Kahwileonardwhite.jpg?v=1684894612',
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/kawhileonardvintageblack.jpg?v=1684894586',
    ],
    sizes: ['S', 'M', 'L', 'XL'],
    colors: ['Black', 'White', 'Vintage Black'],
    category: 'Tee',
  ...
  {
    slug: 'vince-carter-dunk-of-death',
    name: 'Vince Carter "Dunk of Death"',
    price: '$50.00 CAD',
    description: 'Sydney Olympics 2000. Vince Carter leapt clear over 7\'2" French Center Frederic Weis. The Dunk of Death — one of basketball\'s most enduring images. Oversized street style fit.',
    path: '/shop/the-1982/products/vince-carter-dunk-of-death',
    images: [
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/vincecarterblack.jpg?v=1684892956',
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/vinacecarterwhite.jpg?v=1684892938',
      'https://cdn.shopify.com/s/files/1/0633/8258/5529/files/vincecartervintageblack.jpg?v=1684892894',
    ],
    sizes: ['S', 'M', 'L', 'XL'],
    colors: ['Black', 'White', 'Vintage Black'],
    category: 'Tee',
