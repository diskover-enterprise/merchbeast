...
export const boastyProducts: BoastyProduct[] = [
  ...
  {
    slug: 'boasty-wave-tee-white',
    name: 'Wave Tee — White',
    price: '$48.00 CAD',
    description: 'Oversized cut with a hand-drawn wave graphic. Made for the water.',
    path: '/shop/boasty-collective/products/boasty-wave-tee-white',
  ...
  {
    slug: 'boasty-island-cap-white',
    name: 'Island Cap — White',
    price: '$40.00 CAD',
    description: 'Unstructured 6-panel cap with embroidered Boasty Collective script. One size fits all.',
    path: '/shop/boasty-collective/products/boasty-island-cap-white',
  ...
  {
    slug: 'boasty-island-cap-navy',
    name: 'Island Cap — Navy',
    price: '$40.00 CAD',
    description: 'Unstructured 6-panel cap with embroidered Boasty Collective script. One size fits all.',
    path: '/shop/boasty-collective/products/boasty-island-cap-navy',
