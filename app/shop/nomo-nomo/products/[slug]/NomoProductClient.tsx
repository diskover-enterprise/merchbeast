...
export default function NomoProductClient({ product, related }: { product: Product; related: Product[] }) {
  ...
  return (
    <div style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", background: '#0d0d0d', color: '#fff', minHeight: '100vh' }}>
      <style>{`
        ...
        @media (max-width: 480px) { .nn-related-grid { grid-template-columns: 1fr; } }
      `}</style>
