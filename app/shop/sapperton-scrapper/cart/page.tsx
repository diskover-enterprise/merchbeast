...
export default function SappertonCartPage() {
  ...
  return (
    <div style={{ fontFamily: "'Barlow Condensed', 'Arial Narrow', sans-serif", background: '#9a9488', color: '#b8860b', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <style>{`
        ...
        .ss-cart-nav { position: sticky; top: 0; z-index: 100; height: 88px; background: #9a9488; display: flex; align-items: center; justify-content: space-between; padding: 0 48px; border-bottom: 2px solid #b8860b; }
        ...
        .ss-cart-browse { display: inline-block; padding: 16px 40px; background: #b8860b; color: #9a9488; text-decoration: none; font-size: 13px; font-weight: 900; font-style: italic; letter-spacing: 0.2em; text-transform: uppercase; font-family: 'Barlow Condensed', sans-serif; }
        ...
        .ss-cart-footer-brand { font-size: 20px; font-weight: 900; font-style: italic; color: #9a9488; text-transform: uppercase; }
