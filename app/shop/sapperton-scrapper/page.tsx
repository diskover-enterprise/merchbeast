...
import { SappertonStorefront } from '@/components/storefront/SappertonStorefront'
import { TrackView } from '@/components/storefront/TrackView'

export const revalidate = 0

export default async function SappertonShopPage() {
  ...
  return <>
    ...
    <SappertonStorefront heroImage={shop?.bannerImage ?? null} activeSale={activeSale} dbProducts={dbProducts} />
  </>
}
