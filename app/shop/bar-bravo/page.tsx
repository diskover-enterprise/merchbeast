...
import { BarBravoStorefront } from '@/components/storefront/BarBravoStorefront'
import { TrackView } from '@/components/storefront/TrackView'

export const revalidate = 0

export default async function BarBravoShopPage() {
  ...
  return <>
    ...
    <BarBravoStorefront heroImage={shop?.bannerImage ?? null} activeSale={activeSale} dbProducts={dbProducts} />
  </>
}
