          ...
          <div className="db-modal-overlay">
            <div className="db-modal" style={{ maxWidth: 560 }}>
              ...
              <div className="db-modal-body">
                ...
                <div className="db-field">
                  <label>Sort Order <span style={{ color: 'var(--ink-mute)', fontWeight: 400 }}>(lower number = shown first)</span></label>
                  <input type="number" min="0" value={form.sortOrder} onChange={e => setForm({ ...form, sortOrder: e.target.value })} placeholder="0" />
                </div>
                <div className="db-field">
